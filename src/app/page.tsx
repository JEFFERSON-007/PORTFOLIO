...
import { Code2, Cpu, Download, Globe, Mail, MapPin, Send, Phone, MessageCircle } from "lucide-react";
        ...
        <main className="relative bg-[#050505] text-white selection:bg-neon-blue selection:text-black">
            ...
            <div className="relative z-10">
                ...
                <section id="home" className="relative h-screen w-full flex flex-col items-center justify-center p-6 text-center">
                    ...
                    >
                        <h1 className="text-[12vw] md:text-[8vw] lg:text-[7vw] font-black leading-[0.9] tracking-tighter uppercase bg-gradient-to-br from-white via-neon-blue to-neon-purple bg-clip-text text-transparent mb-6 text-shadow-glow">
                            JEFFERSON<br />RAJA A
                        </h1>
                        <div className="text-[10px] md:text-2xl font-light tracking-[0.2em] md:tracking-[0.5em] uppercase text-neon-blue mb-10 md:mb-12 px-4">
                            <Typewriter
                                options={{
                                    strings: [
                    ...
                    <div className="horizontal-container">
                        ...
                        <section id="about" className="panel section py-0 w-screen">
                            <div className="max-w-6xl w-full flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-20 items-center px-4 md:px-10 h-full">
                                <div className="panel-content z-20 bg-black/60 md:bg-black/40 md:backdrop-blur-2xl p-6 md:p-12 rounded-[30px] md:rounded-[40px] border border-white/10 shadow-2xl order-2 md:order-1 md:overflow-y-auto md:max-h-[80vh] mt-20 md:mt-0">
                        ...
                        <section id="skills" className="panel section px-4 md:px-10 w-screen">
                            <div className="w-full max-w-6xl panel-content md:overflow-y-auto md:max-h-[80vh] px-2 pb-32 md:pb-0">
                                <div className="flex justify-between items-end mb-10 md:mb-16">
                                    <h2 className="text-3xl md:text-8xl font-black bg-gradient-to-r from-neon-blue to-white bg-clip-text text-transparent uppercase tracking-tighter">Skills</h2>
                        ...
                        <section id="projects" className="panel section px-4 md:px-10 w-screen">
                            <div className="w-full max-w-6xl panel-content md:overflow-y-auto md:max-h-[80vh] px-2 pb-32 md:pb-0">
                                <h2 className="text-3xl md:text-8xl font-black mb-10 md:mb-16 text-right bg-gradient-to-l from-neon-blue to-white bg-clip-text text-transparent uppercase tracking-tighter">Projects</h2>
                        ...
                        <section id="timeline" className="panel section px-4 md:px-10 w-screen">
                            <div className="max-w-4xl w-full panel-content md:overflow-y-auto md:max-h-[80vh] px-2 pb-32 md:pb-0">
                                <h2 className="text-3xl md:text-7xl font-bold mb-10 md:mb-12 bg-gradient-to-r from-neon-purple to-neon-blue bg-clip-text text-transparent uppercase tracking-tighter">Timeline</h2>
                                <div className="space-y-12 border-l-2 border-white/10 pl-8 md:pl-12 ml-4 md:ml-6 hover:border-neon-purple/50 transition-colors duration-700">
                                    {[
                                        { year: "2026", role: "Meta PyTorch OpenEnv Hackathon", company: "Grand Finalist" },
                        ...
                        <section id="connect" className="panel section px-4 md:px-10 w-screen">
                            <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 panel-content md:overflow-y-auto md:max-h-[80vh] px-2 pb-32 md:pb-0">
                                <div>
                                    <h2 className="text-3xl md:text-7xl font-bold mb-6 md:mb-8 bg-gradient-to-r from-neon-pink to-white bg-clip-text text-transparent uppercase tracking-tighter">Connect</h2>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="mt-12 pt-8 border-t border-white/5">
                                            <div className="flex flex-col xl:flex-row gap-4 w-full">
                                                <a
                                                    href="https://wa.me/918778646082"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    className="inline-flex flex-1 items-center justify-center gap-2 px-4 py-4 bg-green-500 text-white font-black uppercase tracking-[0.2em] text-[10px] sm:text-xs hover:bg-white hover:text-green-600 transition-all duration-300 shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] !opacity-100"
                                                >
                                                ...
                                                <a 
                                                    href="/resume.pdf" 
                                                    target="_blank" 
                                                    className="inline-flex flex-1 items-center justify-center gap-2 px-4 py-4 bg-white/10 text-white border border-white/20 font-black uppercase tracking-[0.2em] text-[10px] sm:text-xs hover:bg-neon-pink hover:border-neon-pink transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,0,255,0.5)] cursor-pointer backdrop-blur-md"
                                                >
                                                    <Download size={16} /> Resume
                                                </a>
                                            </div>
                                            <p className="text-[9px] uppercase tracking-[0.2em] opacity-30 mt-4 leading-relaxed">
                                                Click to open WhatsApp directly.<br />
                                ...
                                <div className="glass p-6 md:p-10 neon-border-blue relative overflow-hidden mt-10 md:mt-0">
                                    ...
                                    <form onSubmit={async (e) => {
                                        ...
                                        // Web3Forms Access Key (will be replaced by user or agent)
                                        data.access_key = "d42ec96a-443a-42aa-b197-9c32f546e5a6";
                                        ...
                                        <button
                                            ...
                                            className={`group flex items-center justify-center w-full font-bold py-5 uppercase tracking-[0.4em] transition-all duration-500 !opacity-100 relative z-30 overflow-hidden ${status === "sent" ? "bg-green-500 text-white" :
                                        ...
                                        >
                                            ...
                                            {status === "idle" && (
                                                <Send size={18} className="absolute right-8 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1" />
                                            )}
                                        </button>
